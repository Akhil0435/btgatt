					...
					const void *param, void *user_data)
{
	...
	size_t expected_len;
	int i;
        uint16_t opcodes_buffer[MAX_OPCODES]; // Assuming MAX_OPCODES is the maximum number of opcodes
	...
	/*opcode = rp->opcodes;*/
        memcpy(opcodes_buffer, rp->opcodes, num_commands * sizeof(uint16_t));
         opcode = opcodes_buffer;
