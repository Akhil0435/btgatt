...
am__append_16 = emulator/btvirt emulator/b1ee \
	...
	tools/hcisecfilter tools/btmgmt \
	tools/btinfo tools/btattach tools/btsnoop \
	tools/btproxy tools/btiotest tools/bneptest \
	tools/mcaptest tools/cltest tools/oobtest \
	tools/seq2bseq tools/nokfw \
	tools/create-image tools/ibeacon \
...
#am__append_29 = -DANDROID_VERSION=0x050100
#am__append_30 = android/system-emulator \
#	android/bluetoothd-snoop android/bluetoothd \
#	android/avdtptest android/haltest \
#	android/android-tester android/ipc-tester
#am__append_31 = android/bluetooth.default.la \
#	android/audio.a2dp.default.la \
#	android/audio.sco.default.la
#am__append_32 = android/test-ipc
am__append_33 = $(rules_DATA)
am__append_34 = $(unit_tests)
TESTS = $(am__EXEEXT_9)
am__append_35 = dbus-run-session --
#am__append_36 = $(manual_pages)
subdir = .
...
am__android_bluetoothd_SOURCES_DIST = android/main.c src/log.c \
	...
	android/scpp.h android/scpp.c android/dis.h android/dis.c \
	android/bas.h android/bas.c android/hog.h android/hog.c \
...
#	android/hidhost.$(OBJEXT) android/scpp.$(OBJEXT) \
#	android/dis.$(OBJEXT) android/bas.$(OBJEXT) \
#	android/hog.$(OBJEXT) android/ipc.$(OBJEXT) \
...
am_monitor_btmon_OBJECTS = monitor/main.$(OBJEXT) \
	...
	monitor/avctp.$(OBJEXT) monitor/rfcomm.$(OBJEXT) \
...
am_unit_test_hog_OBJECTS = unit/test-hog.$(OBJEXT) $(am__objects_19) \
	android/hog.$(OBJEXT) android/scpp.$(OBJEXT) \
	android/bas.$(OBJEXT) android/dis.$(OBJEXT) src/log.$(OBJEXT) \
	attrib/att.$(OBJEXT) attrib/gatt.$(OBJEXT) \
...
SOURCES = $(profiles_sap_libsap_a_SOURCES) \
	...
	$(tools_create_image_SOURCES) $(tools_gap_tester_SOURCES) \
	$(tools_gatt_service_SOURCES) $(tools_hci_tester_SOURCES) \
	...
	tools/l2ping.c tools/l2test.c $(tools_mcaptest_SOURCES) \
...
ACLOCAL = ${SHELL} /home/engineer/bluez/bluez-5.31/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} /home/engineer/bluez/bluez-5.31/missing autoconf
AUTOHEADER = ${SHELL} /home/engineer/bluez/bluez-5.31/missing autoheader
AUTOMAKE = ${SHELL} /home/engineer/bluez/bluez-5.31/missing automake-1.14
AWK = gawk
CC = gcc
...
LTLIBOBJS = 
MAINT = 
MAKEINFO = ${SHELL} /home/engineer/bluez/bluez-5.31/missing makeinfo
MANIFEST_TOOL = :
MISC_CFLAGS = 
MISC_LDFLAGS = 
...
UDEV_LIBS = -ludev
VERSION = 5.31
WARNING_CFLAGS =  -Wall -Werror -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wdeclaration-after-statement -Wmissing-declarations -Wredundant-decls -Wcast-align -Wswitch-enum -Wformat -Wformat-security -DG_DISABLE_DEPRECATED -DGLIB_VERSION_MIN_REQUIRED=GLIB_VERSION_2_28 -DGLIB_VERSION_MAX_ALLOWED=GLIB_VERSION_2_28
abs_builddir = /home/engineer/bluez/bluez-5.31
abs_srcdir = /home/engineer/bluez/bluez-5.31
abs_top_builddir = /home/engineer/bluez/bluez-5.31
abs_top_srcdir = /home/engineer/bluez/bluez-5.31
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/engineer/bluez/bluez-5.31/install-sh
...
dist_noinst_MANS = $(am__append_36)
...
EXTRA_DIST = src/bluetooth.service.in src/org.bluez.service \
	...
	obexd/src/obex.service.in obexd/src/org.bluez.obex.service \
	...
	doc/obex-agent-api.txt tools/magic.btsnoop \
	$(manual_pages:.1=.txt)
include_HEADERS = $(am__append_1)
AM_CFLAGS = $(WARNING_CFLAGS) $(MISC_CFLAGS) $(am__append_29) \
...
unit_tests = $(am__append_32) unit/test-eir unit/test-uuid \
...
tools_mcaptest_LDADD = lib/libbluetooth-internal.la -lglib-2.0
...
android/hidhost.$(OBJEXT): android/$(am__dirstamp) \
	android/$(DEPDIR)/$(am__dirstamp)
android/scpp.$(OBJEXT): android/$(am__dirstamp) \
	android/$(DEPDIR)/$(am__dirstamp)
android/dis.$(OBJEXT): android/$(am__dirstamp) \
	android/$(DEPDIR)/$(am__dirstamp)
android/bas.$(OBJEXT): android/$(am__dirstamp) \
	android/$(DEPDIR)/$(am__dirstamp)
android/hog.$(OBJEXT): android/$(am__dirstamp) \
	android/$(DEPDIR)/$(am__dirstamp)
...
include android/$(DEPDIR)/scpp.Po
